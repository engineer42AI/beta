...
class Client:
    ...
    def get_run_url(
        ...
        *,
        ...
        Not recommended for use within your agent_langgraph runtime.
        ...
        **kwargs: Any,
        ...
        Example:
            .. code-block:: python
                ...
                dataset = client.create_dataset("agent_langgraph-qa")

                examples = [
                    {
                        "inputs": {"question": "what's an agent_langgraph"},
                        "outputs": {"answer": "an agent_langgraph is..."},
                        "metadata": {"difficulty": "easy"},
                    },
                    {
                        "inputs": {
                            "question": "can you explain the agent_langgraph architecture in this diagram?"
                        },
                ...
                response = client.create_examples(dataset_name="agent_langgraph-qa", examples=examples)
                # -> {"example_ids": [...
        """  # noqa: E501
        ...
        Example:
             ...
             .. code-block:: python
                 ...
                 updates = [
                     {
                         "id": example_ids[0],
                         "inputs": {"question": "what isn't an agent_langgraph"},
                         "outputs": {"answer": "an agent_langgraph is not..."},
                     },
                     {
                         "id": example_ids[1],
                 ...
                 response = client.update_examples(dataset_name="agent_langgraph-qa", updates=updates)
                 # -> {"example_ids": [...
        """  # noqa: E501
