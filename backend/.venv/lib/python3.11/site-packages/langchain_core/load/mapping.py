...
SERIALIZABLE_MAPPING: dict[tuple[str, ...], tuple[str, ...]] = {
    ...
    ("langchain", "schema", "agent_langgraph", "AgentAction"): (
        "langchain_core",
        "agents",
        "AgentAction",
    ),
    ("langchain", "schema", "agent_langgraph", "AgentFinish"): (
        "langchain_core",
        "agents",
        "AgentFinish",
    ),
    ...
    ("langchain", "schema", "agent_langgraph", "AgentActionMessageLog"): (
        "langchain_core",
        "agents",
        "AgentActionMessageLog",
    ),
    ("langchain", "schema", "agent_langgraph", "ToolAgentAction"): (
        "langchain",
        "agents",
        "output_parsers",
        "tools",
...
_OG_SERIALIZABLE_MAPPING: dict[tuple[str, ...], tuple[str, ...]] = {
    ...
    ("langchain", "schema", "agent_langgraph", "OpenAIToolAgentAction"): (
        "langchain",
        "agents",
        "output_parsers",
        "openai_tools",
