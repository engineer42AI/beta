...
class FileCallbackHandler(BaseCallbackHandler):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            with FileCallbackHandler("output.txt") as handler:
                # Use handler with your chain/agent_langgraph
    ...
    def on_agent_action(
        ...
        """Handle agent_langgraph action by writing the action log.

        Args:
            action: The agent_langgraph action containing the log to write.
    ...
    def on_agent_finish(
        ...
        """Handle agent_langgraph finish by writing the finish log.

        Args:
            finish: The agent_langgraph finish object containing the log to write.
            color: Color override for this specific output. If ``None``, uses
                ``self.color``.
            **kwargs: Additional keyword arguments.
