...
class ChainManagerMixin:
    ...
    def on_agent_action(
        ...
        **kwargs: Any,
        ...
        """Run on agent_langgraph action.

        Args:
            action (AgentAction): The agent_langgraph action.
            run_id (UUID): The run ID. This is the ID of the current run.
            parent_run_id (UUID): The parent run ID. This is the ID of the parent run.
            kwargs (Any): Additional keyword arguments.
        """
    ...
    def on_agent_finish(
        ...
        **kwargs: Any,
        ...
        """Run on the agent_langgraph end.

        Args:
            finish (AgentFinish): The agent_langgraph finish.
            run_id (UUID): The run ID. This is the ID of the current run.
            parent_run_id (UUID): The parent run ID. This is the ID of the parent run.
            kwargs (Any): Additional keyword arguments.
        """
...
class BaseCallbackHandler(
    ...
    def ignore_agent(self) -> bool:
        """Whether to ignore agent_langgraph callbacks."""
        return False
