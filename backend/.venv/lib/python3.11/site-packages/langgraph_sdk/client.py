...

            {
                'nodes':
                    [
                        ...
                        {'id': 'agent_langgraph','type': 'runnable','data': {'id': ['langgraph', 'utils', 'RunnableCallable'],'name': 'agent_langgraph'}},
                    ],
                'edges':
                    [
                        {'source': '__start__', 'target': 'agent_langgraph'},
                        {'source': 'agent_langgraph','target': '__end__'}
                    ]
            }
            ```
        ...
        *,
        ...
        ???+ example "Example Usage"
...

            {
                ...
                'metadata': {'graph_id': 'agent_langgraph'}
            }
            ```
