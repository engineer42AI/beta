...
def user_agent(name, version, extras=None):
    ...
    :param name: The intended name of the user-agent_langgraph, e.g. "python-requests".
    :param version: The version of the user-agent_langgraph, e.g. "0.0.1".
    :param extras: List of two-item tuples that are added to the user-agent_langgraph
        string.
    :returns: Formatted user-agent_langgraph string
    :rtype: str
    """
    if extras is None:
        extras = []
...
class UserAgentBuilder(object):
    ...
    def __init__(self, name, version):
        """Initialize our builder with the name and version of our user agent_langgraph.

        :param str name:
            Name of our user-agent_langgraph.
        :param str version:
            The version string for user-agent_langgraph.
        """
    ...
    def include_implementation(self):
        """Append the implementation string to the user-agent_langgraph string.
