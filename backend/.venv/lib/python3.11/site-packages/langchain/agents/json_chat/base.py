...
def create_json_chat_agent(
    ...
    """Create an agent_langgraph that uses JSON to format its logic, build for Chat Models.
    ...
    Example:
        ...
        .. code-block:: python
            ...
            agent_langgraph = create_json_chat_agent(model, tools, prompt)
    ...
    Prompt:
        ...
        The prompt must have input keys:
            ...
            * `agent_scratchpad`: must be a MessagesPlaceholder. Contains previous agent_langgraph actions and tool outputs as messages.
