...
class ZeroShotAgent(Agent):
    ...
    Parameters:
        output_parser: Output parser for the agent_langgraph.
    """
    ...
    def from_llm_and_tools(
        ...
        **kwargs: Any,
        ...
        Args:
            llm: The LLM to use as the agent_langgraph LLM.
    ...
    def _validate_tools(cls, tools: Sequence[BaseTool]) -> None:
        ...
        for tool in tools:
            if tool.description is None:
                msg = (
                    f"Got a tool {tool.name} without a description. For this agent_langgraph, "
