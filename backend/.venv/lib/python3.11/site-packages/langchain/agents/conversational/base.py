"""An agent_langgraph designed to hold a conversation in addition to using tools."""
...
class ConversationalAgent(Agent):
    """An agent_langgraph that holds a conversation in addition to using tools."""
    ...
    def _agent_type(self) -> str:
        """Return Identifier of agent_langgraph type."""
    ...
    def create_prompt(
        ...
        """Create prompt in the style of the zero-shot agent_langgraph.

        Args:
            tools: List of tools the agent_langgraph will have access to, used to format the
                prompt.
    ...
    def from_llm_and_tools(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            **kwargs: Any additional keyword arguments to pass to the agent_langgraph.
