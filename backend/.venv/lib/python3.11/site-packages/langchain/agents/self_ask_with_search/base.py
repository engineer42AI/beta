...
def create_self_ask_with_search_agent(
    ...
    """Create an agent_langgraph that uses self-ask with search prompting.
    ...
    Args:
        ...
        prompt: The prompt to use, must have input key `agent_scratchpad` which will
            contain agent_langgraph actions and tool outputs.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            agent_langgraph = create_self_ask_with_search_agent(model, tools, prompt)
    ...
    Prompt:
        ...
        The prompt must have input key `agent_scratchpad` which will
            contain agent_langgraph actions and tool outputs as a string.
    ...
    if len(tools) != 1:
        msg = "This agent_langgraph expects exactly one tool"
        raise ValueError(msg)
    tool = next(iter(tools))
    if tool.name != "Intermediate Answer":
        msg = "This agent_langgraph expects the tool to be named `Intermediate Answer`"
        raise ValueError(msg)
