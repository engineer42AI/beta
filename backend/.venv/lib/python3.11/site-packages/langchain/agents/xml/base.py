...
class XMLAgent(BaseSingleActionAgent):
    ...
    Args:
        tools: list of tools the agent_langgraph can choose from
    ...
    tools: list[BaseTool]
    """List of tools this agent_langgraph has access to."""
    llm_chain: LLMChain
...
def create_xml_agent(
    ...
    *,
    ...
    """Create an agent_langgraph that uses XML to format its logic.

    Args:
        llm: LLM to use as the agent_langgraph.
        tools: Tools this agent_langgraph has access to.
        prompt: The prompt to use, must have input keys
            `tools`: contains descriptions for each tool.
            `agent_scratchpad`: contains previous agent_langgraph actions and tool outputs.
    ...
    Example:
        ...
        .. code-block:: python
            ...
            prompt = hub.pull("hwchase17/xml-agent_langgraph-convo")
            model = ChatAnthropic(model="claude-3-haiku-20240307")
            tools = ...

            agent_langgraph = create_xml_agent(model, tools, prompt)
    ...
    Prompt:
        ...
        The prompt must have input keys:
            * `tools`: contains descriptions for each tool.
            * `agent_scratchpad`: contains previous agent_langgraph actions and tool outputs as an XML string.
