...
def create_conversational_retrieval_agent(
    ...
    **kwargs: Any,
    ...
    """A convenience method for creating a conversational retrieval agent_langgraph.

    Args:
        llm: The language model to use, should be ChatOpenAI
        tools: A list of tools the agent_langgraph has access to
        remember_intermediate_steps: Whether the agent_langgraph should remember intermediate
            ...
            there is relevant information in there, the agent_langgraph can use it to answer
    ...
    Returns:
        An agent_langgraph executor initialized appropriately
    """
