...
class XMLAgentOutputParser(AgentOutputParser):
    """Parses tool invocations and final answers from XML-formatted agent_langgraph output.

    This parser extracts structured information from XML tags to determine whether
    an agent_langgraph should perform a tool action or provide a final answer. It includes
