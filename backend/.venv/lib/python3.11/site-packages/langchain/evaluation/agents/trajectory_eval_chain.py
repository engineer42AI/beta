...
class TrajectoryEvalChain(AgentTrajectoryEvaluator, LLMEvalChain):
    ...
    .. code-block:: python
        ...
        agent_langgraph = initialize_agent(
            tools=[geography_answers],
            llm=llm,
            agent_langgraph=AgentType.OPENAI_FUNCTIONS,
            return_intermediate_steps=True,
        )

        question = "How many dwell in the largest minor region in Argentina?"
        response = agent_langgraph(question)
    ...
    """A list of tools available to the agent_langgraph."""
    eval_chain: LLMChain
    ...
    def _tools_description(self) -> str:
        """Get the description of the agent_langgraph tools.

        Returns:
            str: The description of the agent_langgraph tools.
        """
...
Description: {tool.description}"""
    ...
    def get_agent_trajectory(
        ...
        """Get the agent_langgraph trajectory as a formatted string.

        Args:
            steps (Union[str, List[Tuple[AgentAction, str]]]): The agent_langgraph trajectory.

        Returns:
            str: The formatted agent_langgraph trajectory.
        """
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            agent_tools (Optional[Sequence[BaseTool]]): A list of tools
                available to the agent_langgraph.
    ...
    def _evaluate_agent_trajectory(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            input (str): The input to the agent_langgraph.
            agent_trajectory (List[Tuple[AgentAction, str]]):
                The intermediate steps forming the agent_langgraph trajectory.
